    ...
    try {
      ...
      try {
        const createOrderResponse = await axios.post('/orders', {
          ...
          discount_amount: totalDiscount, // ✅ FIXED: Pass the total discount here
          notes: orderData.notes || `Social Commerce order. ${orderStoreId ? `Assigned to Store ID: ${orderStoreId}. ` : 'Warehouse will assign store. '
        ...
        throw orderError; // Let the outer catch handle it
      }
      ...
      try {
        ...
        console.error('❌ Payment processing failed but order was created:', paymentError);
        displayToast(`Order ${createdOrder.order_number} created, but payment failed. Please pay from order list.`, 'error');

        // Redirect regardless of payment success (since order exists)
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 p-4 rounded-lg border border-indigo-200 dark:border-indigo-800">
                      ...
                      <div className="space-y-3">
                        {/* Auto-assign option */}
                        <label className={`flex items-start p-3 rounded-lg border-2 cursor-pointer transition-all hover:bg-white dark:hover:bg-gray-700/50 ${storeAssignmentType === 'auto'
                        ...
                        <label className={`flex items-start p-3 rounded-lg border-2 cursor-pointer transition-all hover:bg-white dark:hover:bg-gray-700/50 ${storeAssignmentType === 'specific'
                            ? 'border-indigo-600 bg-white dark:bg-gray-700/50'
                            : 'border-gray-300 dark:border-gray-600'
                          }`}>
                          <input
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <button
                          ...
                          disabled={isProcessing}
                          className={`flex flex-col items-center justify-center p-3 rounded-lg border-2 transition-all ${paymentOption === 'full'
                        ...
                        <button
                          ...
                          disabled={isProcessing}
                          className={`flex flex-col items-center justify-center p-3 rounded-lg border-2 transition-all ${paymentOption === 'partial'
                        ...
                        <button
                          ...
                          disabled={isProcessing}
                          className={`flex flex-col items-center justify-center p-3 rounded-lg border-2 transition-all ${paymentOption === 'none'
