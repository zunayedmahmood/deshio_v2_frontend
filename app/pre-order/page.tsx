...
const SC_DRAFT_STORAGE_KEY = 'preOrderDraftV2';
const SC_SELECTION_QUEUE_KEY = 'preOrderSelectionQueueV2';
const SC_EDIT_PREFILL_KEY = 'preOrderEditPrefillV2';
const SC_EDIT_CONTEXT_KEY = 'preOrderEditContextV2';
const SC_SELECTED_STORE_STORAGE_KEY = 'preOrderSelectedStoreV2';
...
export default function PreOrderPage() {
  ...
  const saveDraftToSession = () => {
    ...
    try {
      ...
      console.warn('Failed to save preorder draft', e);
    }
  };
  ...
  const persistSelectedStore = (storeId: string | number | null | undefined) => {
    ...
    try {
      ...
      if (normalized) {
        ...
        localStorage.setItem('preOrderSelectedStore', normalized);
      }
    } catch {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('Failed to restore preorder draft', e);
    } finally {
      draftHydratedRef.current = true;
    }
  }, []);
  ...
  const handleConfirmOrder = async () => {
    ...
    try {
      ...
      const orderData = {
        ...
        is_preorder: true,
        preorder_notes: orderNotes?.trim() || 'Preorder created from preorder panel',
            ...
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-4 md:mb-6">
                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                  <h1 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white">Preorder</h1>
                  <button
